...
<head>
  ...
  <title>{{ config('app.name', 'Turistas Futuristas') }} | @yield('head.title')</title>
  <!-- Theme style -->
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-file mr-2"></i> 3 nuevas sugerencias
...
{{--              </div>--}}
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">{{ config('app.name', 'Turistas Futuristas') }}</span>
    </a>
...
{{--  @include('sections.controlSidebar')--}}
